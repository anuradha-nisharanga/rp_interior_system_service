window.addEventListener('load',()=>{
    ...
    userPrivilege = ajaxGetRequest("/privilege/by-logged-user-module/production");
...
const refreshProductionOrderTable = () =>{
    ...
    productionOrderList = ajaxGetRequest("/production/view");
    ...
    fillDataIntoTable(dailyProductionTable, productionOrderList ,displayProperty ,refillPOrderForm, deleteProductionOrder, printPOrder, true, userPrivilege);
